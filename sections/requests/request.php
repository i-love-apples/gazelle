...
<?php } else { ?>
                    <p align="center"><img style="width: 100%;" src="<?=STATIC_SERVER?>/common/noartwork/apps.png" alt="<?=$request->categoryName() ?>" class="tooltip" title="<?= $request->categoryName() ?>" height="220" border="0" /></p>
<?php } ?>
                </div>
            </div>
        </div>
