...
View::show_header(display_str($title), ['js' => 'browse,comments,torrent,bbcode,whutbbcode,cover_art,subscriptions,voting']);
?>
<div class="thin">
    <div class="header">
        <h2><?= $tgroup->link() ?>
...
?>
        <table class="torrent_table details<?= $tgroup->isSnatched() ? ' snatched' : ''?> m_table" id="torrent_details">
            <tr class="colhead_dark">
                ...
                <td class="m_th_right sign snatches"><i alt="Snatches" title="Snatches" class="tooltip fa-sharp fa-solid fa-arrow-rotate-left"></i></td>
                <td class="m_th_right sign seeders"><i alt="Seeders" title="Seeders" class="tooltip fa-sharp fa-solid fa-up"></i></td>
                <td class="m_th_right sign leechers"><i alt="Leechers" title="Leechers" class="tooltip fa-sharp fa-solid fa-down"></i></td>
            </tr>
<?php
if (!$torrentList) {
